...
const AddUserForm = ({ setUsers, searchQuery, setSearchQuery }) => {
     ...
     return (
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-4 rounded shadow space-y-4">
               ...
               <div>
                    <label className="block text-sm text-black dark:text-white">Search</label>
                    <input
                         type="text"
               ...
               <div>
                    <label className="block text-sm text-black dark:text-white">Full Name</label>
                    <input
                         type="text"
                         name="name"
                         value={formData.name}
               ...
               <div>
                    <label className="block text-sm text-black dark:text-white">Password</label>
                    <input
                         type="password"
                         name="password"
               ...
               <div>
                    <label className="block text-sm text-black dark:text-white">Role</label>
                    <select
                         name="role"
                         value={formData.role}
                         onChange={handleChange}
